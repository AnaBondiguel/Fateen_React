export default function reducer(state, action) {
    ...
    switch(action.type) {
        ...
        case 'saveMessage': {
            const updatedReviews = state.reviews.slice(); //copied array
            updatedReviews[state.selectedReviewId].description = state.editBoxMessage; //updated description of the current selected review
